    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">System architecture reviews, interviews, exams, and key calendar dates.</p>
        </div>

        <button
          onClick={() => setShowCreate(!showCreate)}
          className="px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-700 text-white text-xs font-semibold flex items-center space-x-1.5 shadow-sm shadow-rose-500/20 transition-all"
        >
      ...
      {/* Create Event Form */}
      {showCreate && (
        <form onSubmit={handleCreateEvent} className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs space-y-3">
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:border-rose-600"
            required
          />
          <textarea
            ...
            className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs text-slate-900 dark:text-slate-100 focus:outline-none focus:border-rose-600"
          />

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              <label className="block text-[11px] text-slate-600 dark:text-slate-400 mb-1 font-medium">Date</label>
              <input
                type="date"
                value={date}
          ...
          <div className="flex justify-end pt-2">
            <button type="submit" className="px-5 py-2 rounded-xl bg-rose-600 text-white text-xs font-semibold shadow-xs">
              Save Event
            </button>
          </div>
        </form>
      ...
      {editingEvent && (
        <form onSubmit={handleUpdateEvent} className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-rose-300 dark:border-rose-700 shadow-sm space-y-3">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-[11px] text-slate-600 dark:text-slate-400 mb-1 font-medium font-medium">Description</label>
              <textarea
          ...
          <div key={event.id} className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs space-y-4 relative group hover:border-slate-300 dark:hover:border-slate-700 transition-all">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="font-display font-bold text-lg text-slate-900 dark:text-slate-100 mt-1">{event.title}</h3>
              </div>
